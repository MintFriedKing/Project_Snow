    ...
    public class HealArea : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {     
                ...
                healAuras.Add(heal);
                players.Add(other.transform.gameObject);      // Èú , ÇÃ·¹ÀÌ¾î  °°Àº ÀÎµ¦½º ¹øÈ£·Î ¿¬°á

                if (activeHealOverTime.ContainsKey(other.transform.gameObject) == false) //ÀÌ°É Å°·ÎÇÏ´Â  µñ¼Å³Ê¸®  ºñ¾îÀÖ³Ä??
                {
                    Coroutine healCoroutine = StartCoroutine(HealofTime(other.transform.gameObject));
                    activeHealOverTime.Add(other.transform.gameObject ,healCoroutine); // ¿ÉÁ§°ú Èú ÄÚ·çÆ¾ ¿¬°á 
